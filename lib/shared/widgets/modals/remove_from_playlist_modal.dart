...
class RemoveFromPlaylistModal extends StatelessWidget {
  const RemoveFromPlaylistModal({
    super.key,
    required this.music,
  ...
  static void show({
    ...
    Get.dialog(
      RemoveFromPlaylistModal(music: music, onConfirm: onConfirm),
          ...
          children: [
            ...
            Container(
              ...
              child: ShaderMask(
                ...
                child: Icon(Icons.favorite_border_sharp, size: 34.w, color: Colors.white),
              ),
            ),
